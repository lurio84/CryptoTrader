...
- **`RESEARCH_ACTIVE.md`** -- senales validadas y en produccion (Research 1, 3, 4, 6, 8, 11).
  Leer cuando: se trabaja en alertas, backtest en activo, ajustes de thresholds.

- **`RESEARCH_ARCHIVE.md`** -- senales descartadas con datos completos (Research 2, 5, 7, 9, 10).
